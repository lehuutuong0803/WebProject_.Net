...
namespace WebProject.Areas.Admin.Controllers
{
    public class ContactController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Email,Title,Comment")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Email,Title,Comment")] Contact contact)
        {
            if (ModelState.IsValid)
            {
